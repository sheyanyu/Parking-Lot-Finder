...
const result = {"_id":{"$oid":"672f7b192f886f811bf7970d"},"weekday":{"$numberInt":"1"},"ticket":{"$date":{"$numberLong":"946702800000"}},"time":{"$date":{"$numberLong":"946702800000"}},"price":{"$numberInt":"13"},"occupation":{"$numberInt":"80"}}
